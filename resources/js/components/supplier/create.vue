                                    ...
                                    <form class="user" @submit.prevent="supplierInsert" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Shop Name" v-model="form.shop_name">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <small>Phone</small>
                                                    <input type="text" class="form-control" placeholder="Enter Your Phone Number" v-model="form.phone">
